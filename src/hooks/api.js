...
export const SITE_DEFAULTS = {
  ...
  DATASETID: "refcnv",
  DATASETLABEL: "refCNV",
  PROJECTROOTLINK: "http://refcnv.org",
  PROJECTDOCLINK: "https://docs.refcnv.org",
  MASTERROOTLINK: "https://refcnv.org",
  MASTERDOCLINK: "https://docs.refcnv.org",
  NEWSLINK: "https://docs.refcnv.org/news",
  ORGSITELINK: "https://info.baudisgroup.org"
}
// export const MAX_HISTO_SAMPLES = 1000
export const THISYEAR = new Date().getFullYear()
export const BIOKEYS = ["histologicalDiagnosis"]
